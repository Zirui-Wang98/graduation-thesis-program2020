...
{
public:
	my_ICP(double input_mean_square_error_difference_boundary = 0.1);
	~my_ICP();
	...
	void set_mean_square_error_difference_boundary(double input_mean_square_error_difference_boundary = 0.02);
